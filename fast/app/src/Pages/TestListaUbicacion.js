...
import { SHr, SIcon, SInput, SNavigation, SPage, SScrollView2, SText, STheme, SView } from 'servisofts-component';
...
{'codigo': 2,'empresa':'servisofts','descripcion':'Maria lopez','fecha':'07/01/2022','hora':'17:18:00','latitud':'-17.78322832197151','longitud':'-63.174300205346256','grupo':'anillo 1','estado':'1'},
...
{'codigo': 5,'empresa':'servisofts','descripcion':'Casa roja ','fecha':'10/01/2022','hora':'20:18:00','latitud':'-17.78893972583567','longitud':'-63.17494136528752','grupo':'anillo 1','estado':'1'},
...
{'codigo': 8,'empresa':'servisofts','descripcion':'a','fecha':'13/01/2022','hora':'23:18:00','latitud':'-17.78691861488884','longitud':'-63.18554273017388','grupo':'anillo 1','estado':'1'},
...
{'codigo': 11,'empresa':'servisofts','descripcion':'d','fecha':'16/01/2022','hora':'2:18:00','latitud':'-17.78089068004462','longitud':'-63.178863989391196','grupo':'anillo 1','estado':'1'},
...
{'codigo': 13,'empresa':'servisofts','descripcion':'g','fecha':'18/01/2022','hora':'4:18:00','latitud':'-17.784358184886056','longitud':'-63.182535822860196','grupo':'anillo 1','estado':'1'},
...
{'codigo': 16,'empresa':'servisofts','descripcion':'Maria lopez','fecha':'21/01/2022','hora':'7:18:00','latitud':'-17.7720379662059 ','longitud':'-63.18236556971132','grupo':'anillo 1','estado':'1'},
...
{'codigo': 24,'empresa':'servisofts','descripcion':'c','fecha':'09/01/2022','hora':'19:18:00','latitud':'-17.796866643724535','longitud':'-63.18946406495324','grupo':'anillo 2','estado':'1'}];
				...
				<SView col={"xs-12"} height={70} row center border={"transparent"} onPress={() => {
					...
					<SView col={"xs-10"} height row style={{ borderBottomWidth: 1, borderColor: STheme.color.lightGray, justifyContent: 'center', }}  >
						<SView flex row center style={{ justifyContent: 'flex-start', }}  >
							<SText col={"xs-12r"} height={20} backgroundColor={"transparent"} fontSize={15} font={"Roboto"} color={STheme.color.primary} >{obj['longitud']}</SText>
							...
							<SView col={"xs-12"} height={40} row backgroundColor={"transparent"} style={{ overflow: 'hidden', }}   >
								<SText col={"xs-12"} fontSize={12} font={"Roboto"} color={STheme.color.gray} >{obj['latitud']}</SText>
